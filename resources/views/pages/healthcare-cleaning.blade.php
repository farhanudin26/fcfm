...
@section('meta_description', 'Professional healthcare cleaning services in Singapore by Fresh Cleaning Facilities Management. NEA Certified & BCA Registered, trusted for hospitals, clinics, and medical facilities.')
@section('meta_keywords', 'healthcare cleaning singapore, hospital cleaning, clinic cleaning, medical facility cleaning, disinfection services')
@section('body_class', 'wp-singular page-template page-template-elementor_header_footer page page-id-2078 wp-theme-clinox ehf-template-clinox ehf-stylesheet-clinox elementor-default elementor-template-full-width elementor-kit-1756 elementor-page elementor-page-2078')
                    ...
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f5d40fe"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-85c4076 elementor-widget elementor-widget-clenfix-breadcrumb"
                                data-id="85c4076" data-element_type="widget"
                            ...
                            <div class="elementor-element elementor-element-29eb1bf elementor-widget elementor-widget-text-editor"
                                data-id="29eb1bf" data-element_type="widget" data-widget_type="text-editor.default">
                                <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec
                                    ...
                                    leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus,
                                                ...
                                                <div class="banner-btn-wrapper d-flex align-items-center">
                                                    <div class="banner-btn">
                                                        <a class="d-flex justify-content-center align-items-center"
                                                            href="{{ url('/pages/contact') }}"><span>Get A Quote
                                                            </span></a>
                                                    </div>
                                                    <div class="banener-cta d-flex align-items-center">
                                                        <span>or</span> <a href="tel:+6583332999">Whatsapp +65 8333
                                                            2999</a>
                                                    </div>
                                                </div>
                                            </div>
